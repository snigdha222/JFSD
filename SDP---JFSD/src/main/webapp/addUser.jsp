...
<h3 align=center><u>Add User</u></h3>
...
<form:form action="adduserrecord" method="post" modelAttribute="user">
...
<td>
<form:input path="userid" required="required"></form:input>
</td>
</tr>
...
<tr align=center>
<td colspan=2><input type="submit" value="Add User" class="button"></td>
</tr>
